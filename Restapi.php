...
class Restapi extends
{
    ...
    public function filesPut($fileId = false)
    {
        if ($fileId === false) {
    ...
    // Check file
    public function filesHead($fileId)
    {
        if (!$fileId) {
    ...
    public function runsPost()
    {
        ...
        require_once($this->getPathForLanguageTask($language));
